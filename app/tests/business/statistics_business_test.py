...
class StatisticsBusinessTest(TestCase):
    ...
    def test_extract_counter_for_one_match(self, mock_construct):
        ...
        associations = StatisticsBusiness(patch=None)._extract_counter_association_rules(1)
    ...
    def test_extract_counter_for_two_matches(self, mock_construct):
        ...
        associations = StatisticsBusiness(patch=None)._extract_counter_association_rules(2)
    ...
    def test_extract_counter_for_three_matches(self, mock_construct):
        ...
        associations = StatisticsBusiness(patch=None)._extract_counter_association_rules(3)
        self.assertEqual(associations[0].counter, 41)
        self.assertEqual(associations[0].hero, 1)
